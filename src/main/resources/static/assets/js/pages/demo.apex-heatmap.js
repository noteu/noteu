function generateData(a, e) {
    for (var t = 0, r = []; t < a;) {
        var n = (t + 1).toString(), o = Math.floor(Math.random() * (e.max - e.min + 1)) + e.min;
        r.push({x: n, y: o}), t++
    }
    return r
}

var colors = ["#727cf5"], dataColors = $("#basic-heatmap").data("colors"), options = {
...
chart.render();
colors = ["#F3B415", "#F27036", "#663F59", "#6A6E94", "#4E88B4", "#00A7C6", "#18D8D8", "#A9D794", "#46AF78"], dataColors = $("#multiple-series-heatmap").data("colors"), options = {
    chart: {
        height: 380,
        type: "heatmap"
    },
...
colors = ["#fa6767", "#f9bc0d", "#44badc", "#42d29d"], dataColors = $("#color-range-heatmap").data("colors"), options = {
    chart: {
        height: 380,
        type: "heatmap"
    },
...
colors = ["#39afd1", "#0acf97"], dataColors = $("#rounded-heatmap").data("colors"), options = {
    chart: {
        height: 380,
        type: "heatmap"
    },
